      ...
      <div className="navbar bg-navbar-custom">
       ...
       <Link to={'/Mainpage'}>
            ...
            <form className="col-4">    
                <input onChange={this._onChangeInput} placeholder="Tìm kiếm ..." className="form-control bg-input"/>
            </form>
            <div className="col-2 ">
            ...
            <div className="col-3">
            {
                ...
                < span className="logout" onClick={this._onLogout}> Đăng xuất</span> </div> : <Link to={'login'} ><button className="btn btn-primary btn-block"> Đăng nhập </button> </Link>
            }
