                ...
                <div className="row justify-content-center">
                  <div className="col-lg-12">
                    <div className=" mx-auto text-center home_text_personal">
                      <h1 className="home_title  mt-4 font-weight-bold text-white mb-0"><span style={{color:"red"}}>STREAM</span> HAY <br/>NHẬN NGAY<br/><span className="simple-text-rotate font-weight-bold" style={{color:"red"}}> PHẦN THƯỞNG </span></h1>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="text-center text-white">
                  <h2 className="font-weight-bold">Hãy Tìm Phòng Để Stream Nào!</h2>
                  <p className="mx-auto cta_details_mx mt-4 pt-2">Stream nhanh nào để dành được phần quà hấp dẫn.</p>
                  <div className="mt-4 pt-3">
                    <Link to={'/'} className="btn btn_outline_custom btn-rounded">Tạo Phòng Stream Nhanh Nào</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row mt-3">
              <div className="col-lg-12">
                <div className="contact_social_icons text-center mt-3">
                  ...
                  <p className="font-weight-bold mt-4">Số Điện Thoại: 0963 688 733</p>
                  <div className="mt-4">
                    <p className="text-muted mb-0">© Copyright | LHK Team</p>
                  </div>
                </div>
              </div>
            </div>
