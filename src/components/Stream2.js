            ...
            <div className="row">
                ...
                <div className="video-area col-8"> 
                    ...
                    <div id="Player1">
                        ...
                        <p className="name-user">{this.state.NamePlayer1 ? this.state.NamePlayer1 : ' '}</p>
                        <button  className="btn btn-warning vote-click" style={{position: "relative",left: "120px"}} onClick={this.Vote1} > Bình chọn</button>
                    </div>
                    </div>
                <div className="col-6 video-2">
                    ...
                    <div id="Player2">
                        ...
                        <p className="name-user">{this.state.NamePlayer2 ? this.state.NamePlayer2 : ''}</p>
                        <button className="btn btn-warning vote-click" style={{position: "relative",left: "120px"}} onClick={this.Vote2} > Bình chọn </button>
                    </div>

                </div>
                <p className=" time-remain" > Thời gian còn lại: {this.state.Time} </p>  
                </div>
                ...
                <div className="chat">
                    ...
                    <div className="chat-area">
                        ...
                        <button className="btn btn-custom" onClick={this._onSendChatText} >Gửi</button>
                    </div>
                </div>
                </div>
              </div>  
